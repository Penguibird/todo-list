import './ripple.css';
// import OC from '../object-container'
export default class RippleManager {
    static setUp() {
        ...
        for (var x = 0; x < array.length; x++) {
            if (array[x].getAttribute("rippleset") === "true") continue;
            this.setUpButton(array[x]);
        }
    }
    static setUpButton(button) {
        button.setAttribute("rippleset", "true");
